...
export const DEFAULT_SETTINGS = Object.freeze({
    ...
    novelAiArtistTags: '',
    novelAiPromptPresets: [],
    novelAiActivePresetId: '',
    novelAiTagInstruction: '根据用户的画面意图、当前角色和最近上下文，生成适合 NovelAI Diffusion V5 Full 的正面提示词、画师或风格标签、负面提示词。保留角色外观一致性，优先自然语言与准确标签，不要输出解释。',
